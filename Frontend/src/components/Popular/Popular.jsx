...
const Popular = () => {
  ...
  return (
    <div className='bg-linear-to-b from-[#C4E2F5] from-0% to-[#e1ffea22] to-100% flex flex-col gap-2.5 pt-[5vh] pb-[10vh] items-center'>
      <h1 className='text-4xl  tracking-tight text-[#171717] font-semibold'>POPULAR</h1>
      <hr className='w-50 h-1.5 rounded-[10px] bg-[#252525]'/>
      <div className="popular-item w-screen flex mt-12.5 gap-7.5 justify-evenly flex-wrap sm:flex-nowrap">
        {popular.map((item,i)=> {
